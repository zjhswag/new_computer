...
def load_data():
    X = np.load(r"C:\Users\14601\Desktop\2022-Machine-Learning-Specialization-main\Advanced Learning Algorithms\week2\9.Practice Lab Neural network training\data\X.npy")
    y = np.load(r"C:\Users\14601\Desktop\2022-Machine-Learning-Specialization-main\Advanced Learning Algorithms\week2\9.Practice Lab Neural network training\data\y.npy")
    return X, y
